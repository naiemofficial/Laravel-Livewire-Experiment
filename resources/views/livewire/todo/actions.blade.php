            ...
            <div
                ...
                <div class="bg-white border border-gray-200 rounded shadow-lg">
                    <button
                        ...
                        @click="open = false"
                        class="flex items-center w-full px-4 py-2 text-left text-sm text-yellow-600 hover:bg-yellow-600 hover:text-white hover:border-yellow-600 focus:outline-none cursor-pointer">
                    ...
                    <button
                        ...
                        @click="open = false"
                        class="flex items-center w-full px-4 py-2 text-left text-sm text-green-600 hover:bg-green-600 hover:text-white hover:border-green-600 focus:outline-none cursor-pointer">
