        ...
        <div class="w-full flex space-x-3">
            @if($form == 'edit')
                <button
                    type="button"
                    wire:click="cancel"
                    class="w-full justify-center rounded-md bg-gray-300 py-2 px-4 border border-gray-300 text-center text-sm text-gray-700 transition-all focus:bg-gray-400 focus:text-white active:bg-gray-500 disabled:pointer-events-none disabled:opacity-50 cursor-pointer inline-flex items-center gap-x-1"
                >
